...
$(document).ready(function () {
    ...
    $.post("https://auth.iudx.org.in/auth/v1/certificate-info", function (data) {
        ...
        //          $.ajax({
        //     url: "https://auth.iudx.org.in/auth/v1/certificate-info",
        //     // data: data,
        //     type: 'POST',
        ...
        // </div>
        // `)
        _alertify("Require certificate: ", "Please get a certificate to get started", "For more Details: Go here");
    });
});
